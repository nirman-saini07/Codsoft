...
class GUI():
    def __init__(self,master):
        ...
        root.config(bg='#007F73')
        root.resizable(False, False)

        self.label = Label(text="PASSWORD GENERATOR", anchor=N, fg='darkblue', bg='#FFC700', font='arial 20 bold underline')
        ...
        self.user = Label(text="Enter User Name: ", font='times 15 bold', bg='#FFC700', fg='darkblue')
        ...
        self.length = Label(text="Enter Password Length: ", font='times 15 bold', bg='#FFC700', fg='darkblue')
        ...
        self.generated_password = Label(text="Generated Password: ", font='times 15 bold', bg='#FFC700', fg='darkblue')
        ...
        self.generate = Button(text="GENERATE PASSWORD", bd=2, relief='solid', padx=1, pady=1, font='Verdana", 15 bold', fg='#458B00', bg='#E8751A', command=self.generate_pass)
        self.generate.grid(row=11, column=1)

        self.blank_label5 = Label(text="")
        self.blank_label5.grid(row=12, column=0)

        self.accept = Button(text="ACCEPT", bd=2, relief='solid', padx=1, pady=1, font='Helvetica 15 bold italic', fg='#458B00', bg='#FFFAF0', command=self.accept_fields)
        self.accept.grid(row=13, column=1)

        self.blank_label1 = Label(text="")
        self.blank_label1.grid(row=14, column=1)

        self.reset = Button(text="RESET", bd=2, relief='solid', padx=1, pady=1, font='Helvetica 15 bold italic', fg='#458B00', bg='#FFFAF0', command=self.reset_fields)
